...
pub struct DownstreamConnection {
    ...
    pub sender_outgoing: Sender<json_rpc::Response>,
    /// Receiver from `Translator::sender_to_downstream`
    pub receiver_outgoing: Receiver<json_rpc::Response>,
    /// Sends to `Translator::receiver_from_downstream`
    pub sender_upstream: Sender<json_rpc::Message>,
    /// Receiver from `Translator::sender_to_downstream`
    pub receiver_upstream: Receiver<json_rpc::Message>,
}
